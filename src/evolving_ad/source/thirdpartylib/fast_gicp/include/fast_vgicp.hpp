...
#include "../include/fast_gicp.hpp"
#include "../include/fast_vgicp_voxel.hpp"
 ...
 */
template <typename PointSource, typename PointTarget> class FastVGICP : public FastGICP<PointSource, PointTarget>
{
  public:
    using Scalar = float;
