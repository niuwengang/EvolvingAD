...
#include "../include/gicp_settings.hpp"
...
static std::vector<Eigen::Vector3i, Eigen::aligned_allocator<Eigen::Vector3i>> neighbor_offsets(
...
template <typename PointT> class GaussianVoxelMap
{
  public:
    ...
    void create_voxelmap(const pcl::PointCloud<PointT> &cloud,
  ...
  private:
    ...
    using VoxelMap =
        std::unordered_map<Eigen::Vector3i, GaussianVoxel::Ptr, Vector3iHash, std::equal_to<Eigen::Vector3i>,
